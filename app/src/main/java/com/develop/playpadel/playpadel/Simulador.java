...
public class Simulador {
	...
	public String getApellido(){
	 ...
	 public Usuario [] crearUsuarios(int numero){
		...
		for (int i=0; i<numero;i++){
			usuariosCreados[i]= new Usuario(getNombreUsuario(),simularPuntuacionAleatoria());
		}
    ...
    public int [] simularFecha (){

        int [] fechaSimulada = {getNumeroAleatorio(27)+1,getNumeroAleatorio(11)+1,2017,getNumeroAleatorio(23),15*getNumeroAleatorio(3),1};
